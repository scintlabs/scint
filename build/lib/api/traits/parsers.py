...
from scint.api.models import Parameter, Parameters
from scint.api.traits.builders import Builder
from scint.api.types import Struct, Trait


class ParseStrategies(Trait):
    ...
    def parse_function(self, func: Callable):
        ...
        return Builder(
            name=func.__name__, description=desc, parameters=params, code=None
        )
