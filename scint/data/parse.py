...
python_lang = Language("scint/data/etc/languages.so", "python")
swift_lang = Language("scint/data/etc/languages.so", "swift")
javascript_lang = Language("scint/data/etc/languages.so", "javascript")
