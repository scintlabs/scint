...
from src.base.records import Instructions
from src.base.serialize import serialize
from src.base.types import Format
from src.base.utils import import_object, timestamp
...
def _metaprotocol(cls, name: str):
    ...
    dct["protocols"] = [name]
    dct["history"] = []
    config = import_object("src.base.intelligence", "ModelConfig")
    generate = import_object("src.base.intelligence", "generate")
