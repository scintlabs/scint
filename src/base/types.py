...
from src.base.utils import import_object
...
class Format(Enum):
    Message = ("src.base.records", "Message")
    Response = ("src.base.records", "Response")
    Metadata = ("src.base.records", "Metadata")
    Task = ("src.compose.outline", "Task")
